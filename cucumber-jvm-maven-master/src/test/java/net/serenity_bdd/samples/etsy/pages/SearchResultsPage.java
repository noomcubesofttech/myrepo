...
// tag::searchByKeyword[]
    ...
    public List<String> getResultTitles() {
        ...
        */
    	...
    	for (WebElement str : listingCards)
    	{
    		list1.add(str.getText());
    	}
...
// end::searchByKeyword[]
    ...
    public Optional<String> getSelectedType() {
        ...
        return (Optional<String>) ((selectedTypes.isEmpty()) ? Optional.absent() : Optional.of(selectedTypes.get(0).getText()));
    }
